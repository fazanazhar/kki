...
class M_dataproduksitemp extends Model
{
    protected $table = 'data_produksi_temp';
    protected $primaryKey = 'P_No'; 
    protected $allowedFields = ['P_No','P_PIC', 'P_Datetime','P_KodeKontainer','P_KodeBatch','P_NamaProduk','P_QTY','P_Status','P_Report','P_QC_QTY','P_Reporter','P_pass'];
