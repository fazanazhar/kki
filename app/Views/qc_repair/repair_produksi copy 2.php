...
<body>
                                    ...
                                    <!-- <li class="nav-item dropdown me-3">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end"
                                            ...
                                            <li>
                                                ...
                                                $a = $produksi['P_Status'];
                                                $b = $produksi['P_Report'];
                                                if ($a == "QC-Accepted" & $b == "Confirmed"): ?>
                                                <div class="alert alert-success alert-dismissible fade show"
                                                    role="alert">
                                                    <strong><?php echo $produksi['P_KodeBatch'];?></strong> the product
                                                    has been picked up by QC.
                                                    ...
                                                    <a type="button" class="btn-close" data-bs-dismiss="alert"
                                                        onclick="closenotifdone()" name="Confirmed"
                                                        aria-label="Close"></a>
                                                </div>
                                                <?php endif; ?>
                                                <?php endforeach; ?>
                                            ...
                                            <li>
                                                ...
                                                <div class="alert alert-warning alert-dismissible fade show"
                                                    role="alert">
                                                    <strong><?php echo $produksi['P_KodeBatch'];?></strong> QC receive
                                                    the report.
                                                    <input type="text" class="form-control text-center"
                                                        id="confirmnoreport" name="confirmnoreport" placeholder="no"
                                                        value="<?php echo $produksi['P_No'];?>" hidden required>
                                                    <input type="text" class="form-control text-center"
                                                        id="confirmbatchreport" name="confirmbatchreport"
                                                        placeholder="batch"
                                                        value="<?php echo $produksi['P_KodeBatch'];?>" hidden required>
                                                    <a type="button" class="btn-close" data-bs-dismiss="alert"
                                                        onclick="closenotifreport()" name="Confirmedreport"
                                                        aria-label="Close"></a>
                                                </div>
                                                <?php endif; ?>
                                                <?php endforeach; ?>
    ...
    function validasi() {
        ...
        var batch2 = batch.toString().substr(0, 10);
