                                ...
                                <div class="d-flex justify-content-center">
                                    <div class="col-14 col-lg-14 col-md-14 mx-auto mt-3">
                                        <div class="form-group position-relative has-icon-left">
                                            <input type="text" class="form-control text-center" id="Container_code"
                                            ...
                                            <div class="col-16">
                                                <div class="form-group position-relative has-icon-left">
                                                    <input type="number" min="1" value="1"
                                                        class="form-control text-center" name="P_QTY" id="P_QTY"
                                                        placeholder="1">
                                                    <div class="form-control-icon">
...
if (flashDataerror) {
    Swal.fire({
        ...
        html: '<form method="post" id="postdontmatch" action="<?php echo base_url()?>/qc_repair_update">' +
            '<h5 class="text-subtitle text-muted">The data Is automatically reported to SPV</h5>' +
