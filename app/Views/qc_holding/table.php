...
<div class="col-9 mx-auto">
    <div class="card-body">
        <div class="container my-4"
            ...
            <table class="table my-2 d-flex flex-column" id="holdingtable">
                <tbody style="overflow-x: auto; white-space: nowrap;">
                    ...
                    <tr>
                        <td class="text-center"><input type="checkbox" class="delete_checkbox"
                                value="<?php echo $data_t['Q2_No'];?> " />
                        </td>
                        <td><?php echo $no;?></td>
                        <td><?php echo $data_t['Q2_KodeKontainer']?></td>
                        <td><?php echo $data_t['Q2_KodeBatch']?></td>
                        <td><?php echo $data_t['Q2_NamaProduk']?></td>
                        <td><?php echo $data_t['Q2_Kategori']?></td>
                        <td><?php echo $data_t['Q2_QTY']?></td>
                        <td>
                            <a class="btn btn-outline-danger btn-sm text-center"
                                onclick="deletee(<?php echo $data_t['Q2_No'];?> , '<?php echo $data_t['Q2_KodeBatch']?>', '<?php echo strval($data_t['P2_KodeKontainer'])?>', <?php echo $data_t['Q2_QTY']?>)">Delete</a>
                        </td>
                    </tr>
                    <?php } ?>
                    <tr>
