        ...
        <div id="main" class='layout-navbar'>
            ...
            <div id="main-content">
                <div class="page-heading">
                    <div class="page-title">
                        <div class="row">
                            <div class="col-12 col-md-6 order-md-1 order-last">
                                <h3>PRODUCTION</h3>
                                <p class="text-subtitle text-muted">Detail Data Production Repair</p>
                            </div>
                            <div class="col-12 col-md-6 order-md-2 order-first">
                                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="<?= base_url()?>/">Dashboard</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">Product Repair List
                                        </li>
                                    </ol>
                                </nav>
                            </div>
                    ...
                    <section class="section">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Product Repair List</h4>
                            </div>
                            <div class="card-body">
                                <div class="container my-4"
                                    ...
                                    <p>
                                    <h1 style="text-align:center">DATA PRODUCTION REPAIR</h1>
                                    </p>
                                    <?php
                    ...
                    ?>
                                    <table class="table my-2" id="produkrepair">
                                        <thead>
                                            <tr>
                                    ...
                                    if ($a == "Dont Match" ): ?>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="<?php echo base_url('masterdeleteproduksirepair/'.$produksi['P_No']);?>"
                                                        class="
                    ...
                    <div class="modal fade" id="editmodal<?php echo $produksi['P_No']; ?>" tabindex="-1"
                        ...
                        <form method="post" id="edit_modal" name="edit_modal"
                            action="<?= site_url('/pdrepairupdate') ?>">
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="edit_modal">Report Qty Production Repair</h5>
                    ...
                    <div class="modal fade" id="editmodall<?php echo $produksi['P_No']; ?>" tabindex="-1"
                        aria-labelledby="edit_modal" aria-hidden="true">
                        <form method="post" id="edit_modal" name="edit_modal"
                            action="<?= site_url('/pdrepair_update') ?>">
    ...
    if (flashDataerror) {
        Swal.fire({
            ...
            html: '<h5 class="text-subtitle text-muted">Data saved successfully</h5>' +
                ...
                '<form method="post" id="postdontmatch" action="<?php echo base_url()?>/detailrp_pd_update">' +
