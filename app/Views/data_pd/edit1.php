...
<head>
    <title>Report Qty Production</title>
...
<body>
    <div class="container">
        ...
        <div class="row">
            <div class="col-2"></div>
            <div class="col-8">
                <form method="post" id="update_detail" name="update_detail" action="<?= site_url('/pdupdate') ?>">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-12 col-md-1">
                            <button type="button" class="btn btn-secondary"
                                onclick="location.href='<?= base_url()?>/data_pd'">Close</button>
                        </div>
                        <div class="col-12 col-md-1">
